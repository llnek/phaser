...
// module def
//////////////////////////////////////////////////////////////////////////////
asterix.Bricks.MainMenu = asterix.XMainMenu.extend({
  appObj: brk
});
...
var PlayBtnCtor = asterix.XButtonFactory.define({
  animSheet: new ig.AnimationSheet('media/bricks/gui/en/play_btn.png', 194, 58),
  size: { x: 194, y: 58 },
  typeiid: 'EntityPlayBtn',
