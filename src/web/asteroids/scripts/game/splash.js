...
// module def
//////////////////////////////////////////////////////////////////////////////
asterix.Asteroids.MainMenu = asterix.XMainMenu.extend({
  appObj: astr
});
...
var PlayBtnCtor = asterix.XButtonFactory.define({
  animSheet: new ig.AnimationSheet(sh.imgFile('asteroids','gui','play_btn.png'), 194, 58),
  size: { x: 194, y: 58 },
...
sh.xcfg.game.splash = asterix.XScreenFactory.define({
  ...
  preStart: function() {
    ...
    var x = (ig.system.width - PlayBtnCtor.prototype.size.x) - 20;
